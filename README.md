# Gaffer Movie Nodes
> [!WARNING]
> The code in this repository is work in progress. It is possible to build and run the plug-ins, but refer to the [issues](https://github.com/ilpvfx/ilp_gaffer_movie/issues) page for a list of known limitations and suggested improvements.
